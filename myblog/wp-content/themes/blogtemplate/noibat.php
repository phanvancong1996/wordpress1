<div class="noibat wow bounceInUp" data-wow-delay=0.3s">
    <h2 class="title-news">Bài viết nổi bật</h2>
             ...
             <?php 
                $args = array(
                    ...
                    'cat' => 16, // lấy bài viết trong chuyên mục có id là 1
                );
            ?>
        ...
        <div class="row">
             ...
             <?php 
                $args = array(
                    ...
                    'cat' => 16, // lấy bài viết trong chuyên mục có id là 1
                    'offset' => 1, // Bỏ đi 1 bài viết đàu tiên
                );
            ?>
            <?php $getposts = new WP_query($args); ?>
            <?php global $wp_query; $wp_query->in_the_loop = true; ?>
            <?php while ($getposts->have_posts()) : $getposts->the_post(); ?>
                <?php //các thành phần cần lấy  ?>
                     <div class="col-xs-4 col-sm-4 col-md-4 style-box wow bounceInUp" data-wow-delay=0.3s">
                        <div class="list-post">
                            <a href="<?php the_permalink(); ?>"><?php echo get_the_post_thumbnail( get_the_id(), 'full', array( 'class' =>'thumnail') ); ?></a>
                            <h4>
